...
namespace Nekres.Notes_Module.Effects {
    public class AlphaMaskEffect : SharedEffect {

        private static readonly AlphaMaskEffect _sharedInstance = new AlphaMaskEffect(NotesModule.ModuleInstance.ContentsManager.GetEffect(@"hlsl\alphamask.mgfx"));
